	...
	export default {
		data() {
			return {
				...
				alarmsInfo: [],
				weekDays: [
					{ name: '一', index: 0, selected: true	},
					{ name: '二', index: 1, selected: true	},
					{ name: '三', index: 2, selected: true	},
					{ name: '四', index: 3, selected: true	},
					{ name: '五', index: 4, selected: true	},
					{ name: '六', index: 5, selected: true	},
					{ name: '日', index: 6, selected: true	},
				],
				volume: 15,
				relayStatus: false,
				startTime: '19:00',
